...
const app = express();
const uploadRoute = require("./upload"); // Import the upload route
...
// Start the server (only needed for local development; Netlify uses serverless functions)
...
module.exports = app; // Export the app for Netlify serverless functions
